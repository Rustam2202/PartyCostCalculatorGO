...
func TestAddEvent(t *testing.T) {
	...
	repo := EventRepository{Db: &database.DataBase{DB: db}}
	...
	if ev.Id != 1 {
		t.Errorf("Add returned the wrong result: got %d, want %d", ev.Id, 1)
	}
...
func TestGetEvent(t *testing.T) {
	...
	result, err := repo.GetByName(ev.Name)
